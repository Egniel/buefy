  ...
  */
  ...
  var getIcons = function getIcons() {
    ...
    if (config$1 && config$1.customIconPacks) {
      icons = merge(icons, config$1.customIconPacks, true);
    }
  ...
  var script$O = {
    ...
    methods: {
      ...
      */
      ...
      timeoutInput: function timeoutInput(value, field) {
        var _this8 = this;
  ...
  var Buefy = {
    install: function install(Vue) {
      ...
      // Options
      setOptions(merge(config$1, options, true)); // Components
      ...
      var BuefyProgrammatic = {
        setOptions: function setOptions$1(options) {
          setOptions(merge(config$1, options, true));
        }
      };
