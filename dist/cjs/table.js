...
var __chunk_10 = require('./chunk-892ea02d.js');
    ...
    */
    ...
    isRowFiltered: function isRowFiltered(row) {
      for (var key in this.filters) {
        ...
        if (Number.isInteger(__chunk_2.getValueByPath(row, key))) {
          if (__chunk_2.getValueByPath(row, key) !== Number(this.filters[key])) return false;
        } else {
          var re = new RegExp(this.filters[key], 'i');
          if (!__chunk_2.getValueByPath(row, key).match(re)) return false;
        }
      }
